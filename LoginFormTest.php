...
require_once 'C:\Users\admin\Documents\Xamppnewinstall\htdocs\ProjectWeb\login.html'; // Link to the file containing the RegisterForm class
...
class LoginFormTest extends TestCase
{
    ...
    {
        // Initialize the RegisterForm class before each test
